...
Answer: Disgruntled Employees, Organized Crime, APTs (Advanced Persistant Threats)

4. What kinds of sources can act as an attack vector for injection attacks?

Answer: Unpatched web servers, Corrupted applications
...
Answer: Input sanitation, Input validation
____
...
Answer: Implementation costs are too high, Lack of support from management, Reactive security posture ("If it ain't broke, don't fix it" mentality)

4. How might an attacker exploit the `robots.txt` file on a web server?

Answer: Using Web Crawlers (Spiders, Spiderbots) to search for private and sensitive information contained on `robots.txt` or a more experienced hacker will modify the URL to retrieve private data, such as content management system information and root directory structure

5. What steps can an organization take to obscure or obfuscate their contact information on domain registry web sites?

Answer: Providing domain registrant information (updating if need be using your domain providers control or access center) that does not include personal names or emails of specific employees.  All phone numbers, email addresses, names, and physical addresses should just belong to a generic corporate account. 
   
6. True or False: As a network defender, `Client-Side` validation is preferred over `Server-Side` validation because it's easier to defend against attacks.

   - Explain why you chose the answer that you did.

Answer: False, Server-Side validation ensures that you've got the final step before anybody is able to get to the data or get to the system as information and data from the user is sent to the server; moreover, experienced users or hackers are able to Bypass Client-Side validation. That being said, the approach as a network defender would be to use BOTH. 
...
Answer: Layer 7 Application - End User Layer

2. A WAF helps protect web applications by filtering and monitoring what?

Answer: HTTP traffic between a web application and the internet
...
1. Define all four factors of multifactor authentication and give examples of each:
   ...
   - Factor 1: Standard Login Inputs - Unique Passwords with a set minimum/special character count, PIN #s, Cognitive Questions

   
   - Factor 2: Physical Keys - Smartcards, Hard Tokens
   
   
   - Factor 3: Biometrics - Facial Recognition, Fingerprints or Hand Geometry, Iris/Retina Scan

   
   - Factor 4: Location - GPS Detection, Callbacks to a Home Phone Number
...
Answer: An interface which restricts (constrains) the content or data to which the user has access only allowing the user to request certain functions or ahve access to specific system resources.
